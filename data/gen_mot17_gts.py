...
seq_root = "./datasets/MOT17/images/test/"
# seq_root = "./datasets/MOT17_SPLIT/train/"
# seq_root = "./datasets/MOT17_SPLIT/val/"
label_root = "./datasets/MOT17/gts/test/"
...
for seq in seqs:
    ...
    mkdirs(osp.join(seq_label_root, "gt"))
    ...
    for fid, tid, x, y, w, h, mark, label, _ in gt:
        ...
        # x += w / 2
        # y += h / 2
        label_fpath = osp.join(seq_label_root, "gt", "format_gt.txt")
        # label_fpath = osp.join(seq_label_root, '{:06d}.txt'.format(fid))
        # label_str = '0 {:d} {:.6f} {:.6f} {:.6f} {:.6f}\n'.format(
        #     tid_curr, x / seq_width, y / seq_height, w / seq_width, h / seq_height)
        label_str = '{:d} {:d} {:d} {:d} {:d} {:d} {:f}\n'.format(
            fid, tid_curr, int(x), int(y), int(w), int(h), float(_))  # in int, without normalization
